...
import { Text, View, Alert, StyleSheet, FlatList, ImageBackground, Image, SafeAreaView, StatusBar, Platform } from 'react-native';
...
keyExtractor=(item,index)=>index.toString()
    ...
    render() {
        if (Object.keys(this.state.meteors).length === 0) {
            ...
            meteros=meteros.slice(0,5) //get first five meteors from the array
            return (
                <View
                    style={{
                        flex: 1,
